...
// 						return ""
// 							.concat(dataCurrency ? dataCurrency : "$")
// 							.concat(parseInt(value, 10));
// 					},
...
// 								.classList.add(targetCheckboxes[n].dataset.checkboxToggleClass);
// 						}
// 					}
// 				} else {
...
// 		var dropdownSelectList = document.querySelectorAll(
// 			'[data-bs-toggle="select"]'
// 		);

// 		var _loop9 = function _loop9(i) {
// 			var dropdownItems =
// 					dropdownSelectList[i].querySelectorAll(".dropdown-item"),
// 				dropdownToggleLabel = dropdownSelectList[i].querySelector(
// 					".dropdown-toggle-label"
// 				),
// 				hiddenInput = dropdownSelectList[i].querySelector(
// 					'input[type="hidden"]'
// 				);
...
// 					e.preventDefault();
// 					var dropdownLabel = this.querySelector(
// 						".dropdown-item-label"
// 					).innerText;
